...
export namespace wcf {
    ...
    export class MsgTypes extends pb_1.Message {
        ...
        get types() {
            return pb_1.Message.getRepeatedWrapperField(this, MsgTypes.Types, 1) as MsgTypes.Types[];
        }
        ...
        static fromObject(data: {
            ...
            if (data.types != null) {
                message.types = data.types.map(item => MsgTypes.Types.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.types != null) {
                data.types = this.types.map((item: MsgTypes.Types) => item.toObject());
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.types.length)
                writer.writeRepeatedMessage(1, this.types, (item: MsgTypes.Types) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): MsgTypes {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.types, () => pb_1.Message.addToRepeatedWrapperField(message, 1, MsgTypes.Types.deserialize(reader), MsgTypes.Types));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export namespace MsgTypes {
        export class Types extends pb_1.Message {
            #one_of_decls: number[][] = [];
            constructor(data?: any[] | {
                code?: number;
                label?: string;
            ...
            static deserialize(bytes: Uint8Array | pb_1.BinaryReader): Types {
                const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new Types();
                while (reader.nextField()) {
                    if (reader.isEndGroup())
                        break;
                    switch (reader.getFieldNumber()) {
            ...
            static deserializeBinary(bytes: Uint8Array): Types {
                return Types.deserialize(bytes);
            }
        }
    }
